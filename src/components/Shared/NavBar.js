              ...
              <div className="tab-pane active" id="activities">
                      ...
                      <a href="#" className="d-flex">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <span className="text-muted small">
                            <i className="bi bi-clock me-1" /> Today
                          </span>
                        </div>
                      </a>
                    </li>
                    ...
                    <li className="px-0 list-group-item">
                      <a href="#" className="d-flex">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <span className="text-muted small">
                            <i className="bi bi-clock me-1" /> Yesterday
                          </span>
                        </div>
                      </a>
                    </li>
                    ...
                    <li className="px-0 list-group-item">
                      <a href="#" className="d-flex">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <span className="text-muted small">
                            <i className="bi bi-clock me-1" /> 20 min ago
                          </span>
                        </div>
                      </a>
                    </li>
                ...
                <div className="tab-pane-footer">
                  <a href="#" className="btn btn-success">
                    <i className="bi bi-check2 me-2" /> Make All Read
                  </a>
                  <a href="#" className="btn btn-danger ms-2">
                    <i className="bi bi-trash me-2" /> Delete all
                  </a>
                </div>
              </div>
              <div className="tab-pane" id="notes">
                ...
                <div className="tab-pane-footer">
                  <a href="#" className="btn btn-primary btn-block">
                    <i className="bi bi-plus me-2" /> Add Notes
                  </a>
                </div>
              </div>
